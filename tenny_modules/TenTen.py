from tkinter import *
from random import *
from tenny_modules.Player import Player
import copy

class TenTen:
    def __init__(self):
        # Declare window as Tk instance
        self.window = Tk()
        # Set window title, size, background, and resizable props
        self.window.title("1010")
        self.window.geometry("600x750")
        self.window.configure(background='#474747')
        self.window.resizable(False, False)

        # Declare game as Game instance
        self.game = Game(self)
    ...
    def player_start(self, immediate=True):
...
class Game:
    ...
    def set_filed_preview(self, preview, x, y, full):
        ...
        preview.field[y][x] = full

    def generate_blocks(self, first_run = False):
        self.current_blocks = []
        for i in range(0, 3):
